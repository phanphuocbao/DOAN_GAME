...
import doan.dev.Main;
import doan.dev.Settings;
import doan.dev.scene2d.GameUI;
import doan.dev.scene2d.MenuUI;
import doan.dev.scene2d.VentanaPause;
...
public class GameScreen extends Screens {
	 ...
	 */
	public GameScreen(Main game, boolean showMainMenu) {
		super(game);
